...
These files are the editable sources for the informative visuals used in the
README and documentation. The specification, schema, ontology, and semantic
rules remain the normative sources.

| Source | Rendered asset | Purpose |
| --- | --- | --- |
| `../assets/hdp-at-a-glance.svg` | same file | README overview and system boundary |
